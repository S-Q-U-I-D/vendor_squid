...
SQUID_VERSION := squid-go-$(SQUID_BUILD)-$(SQUID_PLATFORM_VERSION)-$(SQUID_BUILD_DATE)-$(SQUID_BUILD_TYPE)
SQUID_FINGERPRINT := squid-go/$(SQUID_PLATFORM_VERSION)/$(TARGET_PRODUCT_SHORT)/$(SQUID_BUILD_DATE)
else
SQUID_VERSION := squid-$(SQUID_BUILD)-$(SQUID_PLATFORM_VERSION)-$(SQUID_BUILD_DATE)-$(SQUID_BUILD_TYPE)
SQUID_FINGERPRINT := squid/$(SQUID_PLATFORM_VERSION)/$(TARGET_PRODUCT_SHORT)/$(SQUID_BUILD_DATE)
endif
